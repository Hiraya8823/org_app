    ...
    <div class="left_content">
        ...
        <?php if (!empty($current_user)) : ?>
            ...
            <?php if ($current_user['admin'] == 1) : ?>
                ...
                <a class="header_logout_button" href="/admin/news/new.php" class="nav-link">news登録</a>
                <a class="header_logout_button" href="/admin/product/new.php" class="nav-link">商品登録</a>
            <?php else : ?>
                <a class="header_logout_button" href="/logout.php" class="nav-link">ログアウト</a>
